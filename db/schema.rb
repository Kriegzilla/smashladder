...
ActiveRecord::Schema.define(version: 20151009153402) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "avatar",                 default: "http://www.ssbwiki.com/images/c/c2/SmashBrosSymbol.svg", null: false
    t.string   "crew_tag"
    t.integer  "wins",                   default: 0,                                                        null: false
    t.integer  "losses",                 default: 0,                                                        null: false
    t.integer  "character_id"
    t.integer  "rank",                   default: 9001,                                                     null: false
  end
